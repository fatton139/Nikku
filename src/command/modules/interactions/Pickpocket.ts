...
export default class Pickpocket extends ExecutableCommand {
    public constructor() {
        super("pickpocket", AccessLevel.REGISTERED, 1, "Attempt to steal coins from someone.", "Usage !f thieve @target");
    }
    ...
    public setCustomAction(): Action {
        return new Action(async (state: OnMessageState) => {
            ...
            const levelDifference = (await dbTarget.getSkillLevel(SkillType.THIEVING)) - (await dbUser.getSkillLevel(SkillType.THIEVING));
